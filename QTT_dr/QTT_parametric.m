...
for p=1:size(estimate_dtminus1_treated)
 estimate_untreateddiff_treated1=@(delta) estimate_untreateddiff_treated_cdf(gammahat,betahat,x0,x1,x2,x3,x4,D,DY2,prob,delta)-estimate_dtminus1_treated(p,1);
...
q_tminus1_0treated = zeros(size(estimate_dtminus1_treated));
for p=1:size(estimate_dtminus1_treated)
 estimate_untreateddiff_treated1=@(delta) estimate_untreateddiff_treated_cdf_procorrect(gammahat,betahat,x0,x1,x2,x3,x4,D,DY2,prob,delta)-estimate_dtminus1_treated(p,1);
q_tminus1_0treated(p,1) = fzero(estimate_untreateddiff_treated1,0);
end
estimate_untreated_treated_q = @(y_input) estimate_untreated_treated_cdf(q_tminus1_0treated,q_tminus1,y_input) - tau;
q_0 = fzero(estimate_untreated_treated_q,0);
...
q_tminus1_0treated = zeros(size(estimate_dtminus1_treated));
for p=1:size(estimate_dtminus1_treated)
 estimate_untreateddiff_treated1=@(delta) estimate_untreateddiff_treated_cdf_condcdfcorrect(gammahat,betahat,x0,x1,x2,x3,x4,D,DY2,prob,delta)-estimate_dtminus1_treated(p,1);
...
Q_1 = quantile(Y3_treat1_temp,0.5);

Q_0 = quantile(Y3_01_temp,0.5);
